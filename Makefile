...
# The plugin protocol's generated Go (M9), on the same terms as the completions
# above: generated by a pinned toolchain, committed because whoever builds from a
# tarball has no protobuf toolchain, and checked so the committed copy cannot
# drift from the .proto it came from.
...
.PHONY: check
check: tidy-check fmt-check proto-check completions-check lint test-full vuln
