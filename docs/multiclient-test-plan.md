...
Give each client its own port and keep them on loopback: the endpoint serves the
process's heap, which in this system means synced file paths and, in a buffer
somewhere, their contents.
